  ...
  return (
    <>
      ...
      <button
        ...
        className="sm:hidden fixed top-4 left-4 z-50 inline-flex h-10 w-10 items-center justify-center rounded-full bg-[#185FA5] text-white shadow-lg ring-1 ring-black/10"
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex flex-col h-screen bg-[#0B1120] text-white transition-all duration-300 ease-in-out shrink-0 ${
          collapsed ? "w-17" : "w-64"
        } ${mobileOpen ? "translate-x-0" : "-translate-x-full"} sm:sticky sm:top-0 sm:translate-x-0 sm:w-64 sm:h-screen sm:overflow-hidden w-[80vw] max-w-70`}
      >
        <div className="absolute top-0 left-0 right-0 h-0.5 bg-linear-to-r from-transparent via-[#3B8BD4] to-transparent opacity-60" />
        ...
        <button
          ...
          className="hidden sm:inline-flex absolute -right-3 top-18 z-10 w-6 h-6 rounded-full bg-[#185FA5] border border-[#0B1120] items-center justify-center hover:bg-[#378ADD] transition-colors shadow-md"
        ...
        <button
          onClick={() => setMobileOpen(false)}
          className="sm:hidden absolute top-4 right-4 z-50 inline-flex h-10 w-10 items-center justify-center rounded-full bg-[#185FA5] text-white shadow-lg border border-white/10 hover:bg-[#378ADD] transition-colors"
